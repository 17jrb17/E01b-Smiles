...
for x in range(50,1600,400):
        ...
        for y in range(300,600,600):
                face_x,face_y = (x,y)
                smile_x,smile_y = (face_x + 0,face_y - 20)
                eye1_x,eye1_y = (face_x - 40,face_y + 40) 
                eye2_x,eye2_y = (face_x + 40,face_y + 40)
                catch1_x,catch1_y = (face_x - 35,face_y + 45) 
                catch2_x,catch2_y = (face_x + 45,face_y + 45) 
